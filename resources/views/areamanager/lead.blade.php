                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <a class="dropdown-item" href="{{route('areamanager.managelead', $lead->id)}}">Manage</a>
                                      <a href="{{route('areamanager.feedback', $lead->id)}}" class="dropdown-item">Feedbacks</a>
                                      <a class="dropdown-item" id="delete" href="{{route('areamanager.deletelead', $lead->id)}}">Delete</a>
                                    </div>
                                  </div>
                                </td>
                                {{-- <td><a href="{{route('areamanager.managelead', $lead->id)}}" class="btn btn-info mr-2">Manage</a><a href="{{route('areamanager.feedback', $lead->id)}}" class="btn btn-info mr-2">Feedbacks</a></td> --}}
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
