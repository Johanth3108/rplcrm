    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{route('areamanager.updateprop', $prop->id)}}" method="POST" id="form">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="district" class="form-control" id="inputDistrict" required>
                            <option value="{{$prop->district}}" selected>{{$prop->district}} </option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select required name="prop_type" class="form-control" id="exampleFormControlSelect1">
                            ...
                            <option value="{{$prop_type->prop_type}}"  @if ($prop_type->prop_type==$prop->prop_type)
                                selected
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control" id="status" required>
                            ...
                            <option value="{{$stat->id}}" @if ($stat->id==$prop->status) selected @endif>{{$stat->status}}</option>
                            @endforeach
                            
                        </select>
                    </div>
                    <button type="submit" id="submit" class="btn btn-primary mr-2">Submit</button>
                    <a href="{{route('areamanager.deleteprop', $prop->id)}}" id="delete" class="btn btn-danger mr-2">Delete</a>
                </form>
            </div>
        </div>
    </div>
...
document.getElementById('{{$prop->state}}').selected = true;
