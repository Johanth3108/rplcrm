            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item" id="dashboard">
                        <a href="{{ route('telecaller.home') }}" class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="charts">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('telecaller.leadtele.view') }}" class="nav-link">Leads received</a>
                                </li>
                            </ul>
                        </div>
                    </li>    
                    ...
                    <li class="nav-item" id="message">
                        <a class="nav-link" data-toggle="collapse" href="#message" role="button"
                        ...
                        <div class="collapse" id="message">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('telecaller.inbox') }}" id="inbox" class="nav-link">Inbox <span
                                            class="badge badge-pill badge-danger">
                                            {{ Auth::user()->notification }}</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('telecaller.message') }}" class="nav-link" id="send">Send message</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <form class="search-form">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <iframe
                                    src="https://free.timeanddate.com/clock/i85z25nz/n553/fs22/ftb/pa0/tt0/tw1/th2/ta1"
                                    frameborder="0" width="434" height="26"></iframe>
                            </div>
                        </div>
                    </form>
                    <ul class="navbar-nav">
                            ...
                            <div class="dropdown-menu" aria-labelledby="profileDropdown">
                                ...
                                <div class="dropdown-body">
                                    <ul class="profile-nav p-0 pt-3">
                                        <li class="nav-item">
                                            <a href="{{ route('telecaller.profile') }}" class="nav-link">
