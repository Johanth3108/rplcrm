    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{route('salesmanager.addemp')}}" method="POST" >
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" name="empph" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Contact number"  required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select required name="usrtype" class="form-control" id="exampleFormControlSelect1">
                            ...
                            <option value="4">Areamanager</option>
