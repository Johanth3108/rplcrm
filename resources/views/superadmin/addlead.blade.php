            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{route('admin.savelead')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="property_name" id="exampleInputUsername1" autocomplete="off" placeholder="Property Name" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="exampleInputUsername1">Address</label>
                        <input type="text" class="form-control" name="address" id="exampleInputUsername1" autocomplete="off" placeholder="Property Location" required>
                    </div>
