...
<form action="{{route('admin.sheet')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-warning mt-2" href="{{route('sample.download.employee')}}">Download a sample file</a>
            </div>
        </div>
    </div>
