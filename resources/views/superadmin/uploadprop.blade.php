...
<form action="{{route('admin.property.upload')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-warning mt-2" href="{{route('sample.download.property')}}">Download a sample file</a>
            </div>
        </div>
    </div>
